  ...
  return (
    <svg viewBox="0 0 200 420" className="w-full h-full max-w-[260px] mx-auto" fill="none">
      ...
      <ellipse cx="100" cy="45" rx="32" ry="38"
        fill={activeOrgan === "brain" ? `${active!.color}20` : "#ffffff10"}
        stroke={activeOrgan === "brain" ? active!.color : "#ffffff"}
        strokeWidth="1.5" strokeOpacity={activeOrgan === "brain" ? 0.8 : 0.3}
      />
      {/* Neck */}
      <rect x="88" y="80" width="24" height="20" rx="8" fill="#ffffff08" stroke="#ffffff" strokeWidth="1" strokeOpacity="0.2" />
      {/* Torso */}
      <path d="M60 100 Q50 100 45 120 L35 200 Q32 220 45 230 L65 250 Q80 260 100 260 Q120 260 135 250 L155 230 Q168 220 165 200 L155 120 Q150 100 140 100 Z"
        fill="#ffffff08" stroke="#ffffff" strokeWidth="1.5" strokeOpacity="0.25" />
      {/* Left arm */}
      <path d="M60 105 Q40 110 25 145 L15 195 Q10 210 18 215 Q25 220 30 210 L50 160"
        fill="#ffffff05" stroke="#ffffff" strokeWidth="1.5" strokeOpacity="0.2" />
      {/* Right arm */}
          ...
          <div className="min-h-[400px] flex items-center">
            <AnimatePresence mode="wait">
              {activeMember && activeOrgan ? (
                      ...
                      <div className="w-20 h-20 rounded-full overflow-hidden border-2 flex-shrink-0"
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.parentElement!.innerHTML = `<div class="w-full h-full flex items-center justify-center bg-white/5 font-inter font-bold text-xl" style="color:${activeMember.color}">${activeMember.name.split(" ").map(n => n[0]).join("")}</div>`;
                          }}
                        />
                      </div>
                      <div>
                ...
                >
                  <div className="w-20 h-20 mx-auto mb-6 border-2 border-[#ffffff]/20 rounded-full flex items-center justify-center">
